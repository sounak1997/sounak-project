...
import {
  ...
  PortalModule,
  TemplatePortal
} from "./chunk-3Q5ORCZ3.js";
import {
  MatButton,
  MatButtonModule
} from "./chunk-3PCWGUMT.js";
import "./chunk-Y3PXICOI.js";
import {
  Breakpoints,
  _animationsDisabled
} from "./chunk-VOPV3HLL.js";
import {
  BreakpointObserver,
  LiveAnnouncer,
  MatCommonModule,
  _IdGenerator
} from "./chunk-2FTV2MRJ.js";
import "./chunk-SCZRWBPC.js";
import {
  Platform
} from "./chunk-GPKQQEQS.js";
...
var MatSnackBarRef = class {
  ...
  _afterDismissed = new import_rxjs.Subject();
  /** Subject for notifying the user that the snack bar has opened and appeared. */
  _afterOpened = new import_rxjs.Subject();
  /** Subject for notifying the user that the snack bar action was called. */
  _onAction = new import_rxjs.Subject();
  /**
...
var MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  ...
  _onAnnounce = new import_rxjs.Subject();
  /** Subject for notifying that the snack bar has exited from view. */
  _onExit = new import_rxjs.Subject();
  /** Subject for notifying that the snack bar has finished entering the view. */
  _onEnter = new import_rxjs.Subject();
...
var MatSnackBar = class _MatSnackBar {
  ...
  _attach(content, userConfig) {
    ...
    this._breakpointObserver.observe(Breakpoints.HandsetPortrait).pipe((0, import_operators.takeUntil)(overlayRef.detachments())).subscribe((state) => {
